...
export const AppInfoComp: FC<{ siteInfo: AppInfo }> = ({ siteInfo }) => {
  ...
  return (
    ...
    <div className='flex items-center py-2 text-xl font-medium text-gray-700 rounded-md'>
      ...
      <div className='flex items-center py-2 text-xl font-medium text-gray-700 rounded-md'>🏌️Chat with 25 years of b2b sales and marketing leadership experience</div>
  )
}
